...
|---|---|---|---|---|
| LAN 1 — Matriz | `201.222.5.0/29` | `.1` – `.6` | `.7` |
| LAN 2 — Matriz | `201.222.5.8/29` | `.9` – `.14` | `.15` | 
| LAN — Filial 1 | `201.222.5.16/29` | `.17` – `.22` | `.23` |
| LAN — Filial 2 | `201.222.5.24/29` | `.25` – `.30` | `.31` |
| LAN — Filial 3 | `201.222.5.32/29` | `.33` – `.38` | `.39` |

### WANs (`/30` — 4 IPs, 2 úteis)

| Enlace | Endereço de rede | Hosts |
|---|---|---|---|
| R1 ↔ R7 | `201.222.5.40/30` | `.41` / `.42` |
| R1 ↔ R2 | `201.222.5.44/30` | `.45` / `.46` |
| R1 ↔ R3 | `201.222.5.48/30` | `.49` / `.50` | 
| R2 ↔ R4 | `201.222.5.52/30` | `.53` / `.54` | 
| R4 ↔ R3 | `201.222.5.56/30` | `.57` / `.58` |
| R3 ↔ R5 | `201.222.5.56/30` | `.61` / `.62` |
| R4 ↔ R6 | `201.222.5.60/30` | `.65` / `.66` |
| R2 ↔ R8 | `201.222.5.64/30` | `.69` / `.70` |
